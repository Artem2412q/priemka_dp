(() => {
  ...
  function fillExactTemplateWorkbook(workbook, exportState) {
    ...
    // Никакую другую структуру чек-листа не меняем: только снимаем техническое
    // скрытие/группировку строк SKU 6–12 из исходного Excel-шаблона.
    for (let summaryRowNumber = 5; summaryRowNumber <= 17; summaryRowNumber++) {
