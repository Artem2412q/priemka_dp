...
const DEFAULT_PREFERENCES = { version: 2, presetId: 'freshness', basePresetId: 'freshness', custom: null };
...
function updateTrigger(tokens, preferences) {
  ...
  button.innerHTML = '<svg class="ui-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 3a9 9 0 0 1 0 18Z"/></svg>';
